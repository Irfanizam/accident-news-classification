...
loaded_model = pickle.load(open('C:/Users/irfanizam/workspace/FYP-Example/FinalFinalFYP/ShortText/st_svm_model.pkl', 'rb'))
dataframe = pd.read_csv('C:/Users/irfanizam/workspace/FYP-Example/FinalFinalFYP/Data1/ArrangedSt.csv')
X = dataframe['tweet']
y = dataframe[['0', '1', '2']]
